...
var precioTotal = 0;
var index = 0;
const api = fetch('conexionpedid.php')
            .then(res=>res.json())
            .then(function(datos){
                datos.forEach(dato => {
                    ...
                    `<div class="card" style="
                            ...
                            <div class="card-body" style="
                              ...
                              <p style="font-size: 1.5em">id del pedido: ${dato.id_pedido}</p>
                              <p class="card-text" style="font-size: 1.5em">id del usuario: ${dato.id_usuario}</p>
                              <p class="card-text" style="font-size: 1.5em">fecha: ${dato.fecha}</p>
